...
# COMPLETAR - INICIO
comparar_nombre_y_edad = (persona_01 == persona_02) and not(edad_01 == edad_02)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
comparar_marca_y_modelo = not (modelo_de_auto <= 2000 and marca_del_auto == "Ford") 
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
comparar_frutas = (bananas<(naranjas/2)) and ((naranjas/2) < (2*manzanas)) and ((2*manzanas <= peras**2))
# COMPLETAR - FIN
